...
T.parties = {
    $tisza: new Party("TISZA", "Tisztelet és Szabadság Párt", "$tisza", "#77cbff", new Image()),
    $fidesz: new Party("Fidesz", "Fidesz – Magyar Polgári Szövetség", "fidesz", "#ff8000", new Image()),
