...
T.parties = {
    ...
    $opnl: new Party("OPNL", "Onafhankelijke Politiek Nederland", "#505050", new Image()),
    $osf: new Party("OSF", "Onafhankelijke Senaatsfractie", "#505050", new Image()),
}
...
T.parties.$opnl.image.src = "logos/OPNL.png";
T.parties.$osf.image.src = "logos/OPNL.png";

T.add_parliament(new Parliament([
    new Fraction(T.parties.$sp, 3),
    new Fraction(new Party("FVH", "Fractie-Visseren-Hamakers", "#808080", new Image()), 1),
    ...
    new Fraction(new Party("FVdS", "Fractie-Van de Sanden", "#808080", new Image()), 1),
    new Fraction(T.parties.$vvd, 9),
    new Fraction(new Party("FW", "Fractie-Walenkamp", "#808080", new Image()), 1),
    new Fraction(T.parties.$bbb, 12),
    new Fraction(new Party("FB", "Fractie-Beukering", "#808080", new Image()), 1),
