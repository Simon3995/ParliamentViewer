...
T.parties = {
    ...
    $snp: new Party("SNP", "Scottish National Party", "$snp", "#ffe562", new Image()),
    ...
    $sdlp: new Party("SDLP", "Social Democratic and Labour Party", "$sdlp", "#00ad00", new Image()),
    $apni: new Party("APNI", "Alliance Party of Northern Ireland", "$apni", "#ffbb00", new Image()),
    $uup: new Party("UUP", "Ulster Unionist Party", "$uup", "#49a4ff", new Image()),
